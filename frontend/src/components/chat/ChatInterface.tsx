      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
            ...
            <div key={message.id} className="space-y-2">
              ...
              {message.response && (
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg rounded-tl-none px-4 py-2 max-w-xs lg:max-w-md">
        ...
        {isLoading && (
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <div className="bg-gray-100 dark:bg-gray-700 rounded-lg rounded-tl-none px-4 py-2 max-w-xs lg:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="flex space-x-3">
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 disabled:opacity-50"
            />
          </div>
          <button
            type="submit"
